 ...
 */var nativeHints = ['native code', '[object MutationObserverConstructor]'];var isNative = function isNative(e) {
  ...
  return Math.max(t['offset' + e], o['client' + e], o['offset' + e], isIE10$1() ? o['offset' + e] + i['margin' + ('Height' === e ? 'Top' : 'Left')] + i['margin' + ('Height' === e ? 'Bottom' : 'Right')] : 0);
  ...
  return setStyles(e.instance.popper, e.styles), setAttributes(e.instance.popper, e.attributes), e.offsets.arrow && setStyles(e.arrowElement, e.offsets.arrow), e;
  ...
  void 0 !== p && console.warn('WARNING: `gpuAcceleration` option moved to `computeStyle` modifier and will not be supported in future versions of Popper.js!');var d = void 0 === p ? t.gpuAcceleration : p,
      ...
      c = getSupportedPropertyName('transform');var u = void 0,
      g = void 0;if (g = 'bottom' == m ? -a.height + l.bottom : l.top, u = 'right' == h ? -a.width + l.right : l.left, d && c) f[c] = 'translate3d(' + u + 'px, ' + g + 'px, 0)', f[m] = 0, f[h] = 0, f.willChange = 'transform';else {
    var _e4 = 'bottom' == m ? -1 : 1,
        _t6 = 'right' == h ? -1 : 1;f[m] = g * _e4, f[h] = u * _t6, f.willChange = m + ', ' + h;
  }var b = { "x-placement": e.placement };return e.attributes = _extends({}, b, e.attributes), e.styles = _extends({}, f, e.styles), e;
  ...
  if (!isModifierRequired(e.instance.modifiers, 'arrow', 'keepTogether')) return e;var o = t.element;if ('string' == typeof o) {
    if (o = e.instance.popper.querySelector(o), !o) return e;
      ...
      a = p ? 'left' : 'top',
      f = p ? 'bottom' : 'right',
      l = getOuterSizes(o)[d];r[f] - l < n[s] && (e.offsets.popper[s] -= n[s] - (r[f] - l)), r[s] + l > n[f] && (e.offsets.popper[s] += r[s] + l - n[f]);var m = r[s] + r[d] / 2 - l / 2;var h = m - getClientRect(e.offsets.popper)[s];return h = Math.max(Math.min(n[d] - l, h), 0), e.arrowElement = o, e.offsets.arrow = {}, e.offsets.arrow[s] = Math.round(h), e.offsets.arrow[a] = '', e;
  ...
  if (isModifierEnabled(e.instance.modifiers, 'inner')) return e;if (e.flipped && e.placement === e.originalPlacement) return e;var o = getBoundaries(e.instance.popper, e.instance.reference, t.padding, t.boundariesElement);var i = e.placement.split('-')[0],
    ...
    if (i !== d || p.length === s + 1) return e;i = e.placement.split('-')[0], n = getOppositePlacement(i);var a = e.offsets.popper,
        ...
        w = !!t.flipVariations && (y && 'start' === r && h || y && 'end' === r && c || !y && 'start' === r && u || !y && 'end' === r && g);(m || b || w) && (e.flipped = !0, (m || b) && (i = p[s + 1]), w && (r = getOppositeVariation(r)), e.placement = i + (r ? '-' + r : ''), e.offsets.popper = _extends({}, e.offsets.popper, getPopperOffsets(e.instance.popper, e.offsets.reference, e.placement)), e = runModifiers(e.instance.modifiers, e, 'flip'));
  }), e;
...
(function (r, v, f) {
																																																															function w(a, b, g) {
																																																																																																																														...
																																																																																																																														};c.init();r.Mousetrap = c;"undefined" !== typeof module && module.exports && (module.exports = c);"function" === "function" && __webpack_require__(8) && !(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
																																																																																																																																																																																													return c;
